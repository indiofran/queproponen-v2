...
VERSION_LABEL = "queProponen-v0.1.932"
DESCRIPTION_VERSION = "Add terms and hotjar"
BUCKET_KEY = os.getenv('APPLICATION_NAME') + '/' + VERSION_LABEL + \
    '-bitbucket_builds.zip'

if sys.argv[1] == 'prod':
	APPLICATION_ENVIRONMENT = os.getenv('APPLICATION_ENVIRONMENT_PROD')
	VERSION_LABEL += "-prod"
else:
	APPLICATION_ENVIRONMENT = os.getenv('APPLICATION_ENVIRONMENT_STAGE')
